...
export default function About() {
    return (
        <section className="w-full flex flex-col lg:flex-row items-center overflow-hidden py-16 lg:py-24">
                ...
                <div className="flex flex-col md:flex-row gap-8 lg:gap-10 text-[#2B2B2B] text-[15px] leading-relaxed font-normal">
                    <div className="w-full md:w-[50%] flex flex-col items-start">
                        <p className="text-[11px] tracking-[0.2em] uppercase font-medium text-[#596854] leading-loose mb-4">
                            At Dr. Maya Reynolds Therapy, I Want to Make That
                            Hope a Reality.
                        </p>
                        <p className="text-[13.5px]">
                            Whether you’re seeking personal growth, looking to
                            work through your trauma, or trying to navigate
                            chronic burnout, I provide a compassionate and safe
                            space to help you find your balance again and
                    ...
                    <div className="w-full md:w-[48%] flex flex-col">
                        <p className="mb-6 text-[13.5px]">
                            ...
                            through is real, valid, and worthy of support. I
                            offer clients in the Santa Monica area and across CA
                            an environment to discover peace and a deeper sense
                            of self in the midst of their struggles. <br></br>
                            As we tap into the power of connection and
                            understanding, you can find your footing again and
            ...
            <div className="w-full lg:w-[35%] xl:w-[32%] min-h-125 lg:min-h-150 relative z-0">
                <Image
                    src="/maya.png"
